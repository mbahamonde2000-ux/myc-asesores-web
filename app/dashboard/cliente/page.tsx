...
const CLIENT_PROFILE_STORAGE_KEY = "myc_client_profile";
...
const [profileSavedMessage, setProfileSavedMessage] = useState("");
  ...
  const savedProfile = localStorage.getItem(CLIENT_PROFILE_STORAGE_KEY);

  if (savedProfile) {
    try {
      const parsedProfile = JSON.parse(savedProfile) as ClientProfile;
      setClientProfile(parsedProfile);
    } catch (error) {
      console.error("Error al cargar la ficha del cliente desde localStorage:", error);
    }
  }
}, [router]);
